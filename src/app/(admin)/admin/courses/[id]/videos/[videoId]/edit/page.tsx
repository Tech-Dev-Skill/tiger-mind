    ...
    <div className="min-h-screen bg-gray-900 text-white p-4 sm:p-8">
      <div className="max-w-2xl mx-auto">
        <header className="mb-8">
          <Link href={`/admin/courses/${awaitedParams.id}/content`} className="text-sm text-orange-400 hover:text-orange-500">
        ...
        <EditVideoForm video={video} courseId={awaitedParams.id} />
      </div>
    </div>
  );
}